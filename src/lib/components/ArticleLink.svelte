...
<a
  ...
  class="m-4 p-4 max-w-sm mx-auto bg-white rounded-lg border border-gray-200 flex items-center space-x-4 transition-colors duration-200 ease-in-out hover:bg-gray-100"
>
  <div>
